...
- In VS Code, go to JAVA PROJECTS > Referenced Libraries > click + > select the JAR
...
| Concept | Where Used |
|---|---|
| Encapsulation | Student.java — private fields with getters |
| Abstraction | DAO pattern — DB logic separated from UI |
| Class & Object | Student object created for each record |
| Constructor | Student() with auto grade calculation |
...
| Update Marks | Auto grade recalculation on update |
...
- Email: damodaranabinaya0@gmail.com
- GitHub: https://github.com/D-Abinaya
- LinkedIn: https://linkedin.com/in/abinaya-damodaran
